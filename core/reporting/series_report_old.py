...
def build_series_report(output_path, series, dunn_image_path=None, trasatti_image_path=None,
    ...
    if trasatti_image_path and trasatti_result:
        story.append(Paragraph("Trasatti Analysis", styles["EZCVSectionHeading"]))
        story.append(Image(trasatti_image_path, width=5.5 * inch, height=4.6 * inch))
        ...
        story.append(_make_table(result_rows))
        story.append(Spacer(1, 6))
        story.append(Paragraph(
